...
public class BitMinerScreenHandler extends ScreenHandler {
    ...
    public BitMinerScreenHandler(int syncId, PlayerInventory playerInventory, PacketByteBuf buf) {
        this(syncId, playerInventory, new SimpleInventory(1), new ArrayPropertyDelegate(1));
        miningSpeed = buf.readInt();
    }

    //This constructor gets called from the BlockEntity on the server without calling the other constructor first, the server knows the inventory of the container
    //and can therefore directly provide it as an argument. This inventory will then be synced to the client.
    public BitMinerScreenHandler(int syncId, PlayerInventory playerInventory, Inventory inventory, PropertyDelegate propertyDelegate) {
        super(BitExchange.BIT_MINER_SCREEN_HANDLER, syncId);
        ...
        int l;
        //Our inventory
        this.addSlot(new SlotOutput(inventory, 0, 80, 35));
